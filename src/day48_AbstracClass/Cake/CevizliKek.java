...
public class CevizliKek extends BaseCake {

    private int ceviz;

    public CevizliKek(int yumurta, int un, int seker, int kabartmaTozu, int sut, int yağ, int ceviz) {
    ...
    public void karistir() {
        ...
        System.out.println("Cevizli = " + getCeviz());
